        ...
        <div className="z-10 sm:order-2 sm:col-span-6">
          ...
          <div className="mt-4">
            {(() => { const base = import.meta.env.BASE_URL; return (
              <img src={`${base}visa.png`} alt="VisaCRM" className="h-28 w-full object-cover rounded-md border border-slate-700" />
            ); })()}
          </div>
          ...
          <div className="mt-3">
            <a href="https://visa.questdigiflex.org" target="_blank" rel="noreferrer" className="inline-flex items-center text-teal-300 hover:text-teal-200">
              Visit live site
